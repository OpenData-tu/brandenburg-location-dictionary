...
public class LocationDictionaryImpl implements LocationDictionary {
    ...
    public void fillDictionary() {
        ...
        locationDictionary.put("Schönefeld, Flughafen 1v", new Location(52.37679, 13.53263));
        ...
        locationDictionary.put("Herzfelde, Hauptstraße v", new Location(52.48188,13.84825));
        locationDictionary.put("Lütte (Belzig) +", new Location(52.19422, 12.56139));
